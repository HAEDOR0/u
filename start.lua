...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " تركيا"
SudosS = {932319116,1848546111}
Sudos = {sudoid,932319116,1848546111}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = '᥉᥆ᥙℛᥴᥱ ƚᥙℛ𝚔ᥱꪗ † . ',url="t.me/ZZ7HZ"}},
}
}
...
{{text = '- تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "تركيا"),data="delnamebot"}},
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '- لـ تنصيب البوتات .',url="https://t.me/A_C_B"}},
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/HAEDOR0/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
end 
if text == "تحديث" then
...
name = string.gsub(name,"هادئ","تركياي")
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "تركيا"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "تركيا"),"اني لقميل "..(redis:get(bot_id..":namebot") or "تركيا"),(redis:get(bot_id..":namebot") or "تركيا").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == "اكلك" or text == (redis:get(bot_id..":namebot") or "تركيا") then
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '᥉᥆ᥙℛᥴᥱ ƚᥙℛ𝚔ᥱꪗ † . ',url="https://t.me/ZZ7HZ"}},
}
}
...
local Text = "*- 𝘞𝘌𝘓𝘤𝘰𝘮𝘦 𝘵𝘰 ᥉᥆ᥙℛᥴᥱ ƚᥙℛ𝚔ᥱꪗ  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '-  ᥉᥆ᥙℛᥴᥱ ƚᥙℛ𝚔ᥱꪗ .',url="https://t.me/ZZ7HZ"}},
{{text = '- 𝘪𝘯𝘧𝘰 ƚᥙℛ𝚔ᥱꪗ .',url="https://t.me/ZZqtz"}},
{{text = '- 𝘋𝘌𝘷𝘦𝘭𝘰𝘱𝘦𝘳 .',url="https://t.me/A_C_B"}},
